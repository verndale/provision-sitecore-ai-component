...
- [pre-commit](../../.husky/pre-commit) → [pre-commit.cjs](../../scripts/graph/pre-commit.cjs), [agent-commit-guard.cjs](../../scripts/hooks/agent-commit-guard.cjs), [pre-commit-journal.cjs](../../scripts/wiki/pre-commit-journal.cjs)
