...
- MUST NOT invent Source strings, field types, or project-specific datasource locations. The clone-equivalent SXA datasource query is the one normative derived convention; all other values are review questions and, once answered, are written verbatim.
